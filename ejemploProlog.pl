...
%1.  Deifimos las relaciones familiares
...
%3. definimos las herencias para los familiares
distribuir_herencia(Total, Nivel1, Nivel2, Nivel3, Num1, Num2, Num3) :-
    % Calculamos las proporciones ajustadas para cada nivel
    ...
    % Asignamos la herencia proporcional a cada nivel
